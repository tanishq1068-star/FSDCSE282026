...
//   h3,
// );
const h21 = <h2 style={{ color: "red", textAlign: "center" }}>welcome</h2>;
const h22 = <h2 style={{ textAlign: "center" }}>welcome to react dom</h2>;
const wrapper=<div style={{border:"2px solid black"}}>{h21}{h22}</div>
const div=<div style={{border:"2px solid black",backgroundColor:"yellow",height:"100px"}}>
    <h2 style={{color:"red"}}>welcome to react dom </h2>
    <h3 style={{color:"brown",backgroundColor:"blue"}}>ABES ENGINEERING COLLEGE</h3>
    <img src="https://www.bing.com/th/id/OIP.fnCmCPk0m964Ynm7U5Y78gAAAA?w=193&h=266&c=8&rs=1&qlt=90&o=6&dpr=2&pid=ImgAns&rm=2" style={{height:200,width:200}}/>
    {wrapper}
    </div>
